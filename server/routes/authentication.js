...
router.post('/register', async (req, res) => {
    const { username, email, password, birth_date, address, phone_number } = req.body
    ...
    db.run(insertValues, [username, email, passwordHash, birth_date, address, phone_number], (err) => {
        if (err) {
